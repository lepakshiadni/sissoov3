...
const Data = [
  ...
  },
  {
    ...
    company: "Facebook",
    imageUrl:
      "https://images.pexels.com/photos/3852243/pexels-photo-3852243.jpeg?auto=compress&cs=tinysrgb&w=600",
    text: "Nice to meet you!",
  },
];

const EmployerFeedData = (props) => {
  const setPopUpButton2 = props.setPopUpButton2;
  ...
  const [open3Array, setOpen3Array] = useState(Array(data.length).fill(false));
  ...
  const toggleHandleMessageMore = (index) => {
  ...
  useEffect(() => {
    try {
      const FetchData = async () => {
        ...
        setPostTrainingData(responce.data.TrainingDataWithImage);
      };
      FetchData();
    } catch (error) {
        ...
        {PostTrainingData.map((post, index) => (
          <div key={index}>
            <div className="centered-section2">
              ...
              <p
                className={showMoreArray[index] ? "show-more2" : "show-less2"}
              ...
              >
                ...
                <div className="skilldata2">
                  <h5>
                    ...
                    <span className="skillchild2">{post.typrOfTraining}</span>
                  </h5>
                  <h5>
                    <span className="skillchild">Experience - </span>
                    <span className="skillchild2">{post.experience} years</span>
                  </h5>
                  <h5>
                    <span className="skillchild">Duration of training -</span>{" "}
                  ...
                  >
                    <h5>
                      ...
                      <span className="skillchild2">{post.modOfTraining}</span>
                    </h5>
                    <div className="skillfooter2">
                      ...
                      <svg
                        ...
                        viewBox="0 0 20 19"
                        fill="none"
                        onClick={() => toggleHandleMessageMore(index)}
                        style={{ cursor: "pointer" }}
                      >
                        <path
