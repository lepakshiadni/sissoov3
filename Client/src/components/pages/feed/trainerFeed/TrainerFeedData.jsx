...
import {
  getPostTrainingRequirementAction,
  addPostTrainingComments,
  getPostTrainingComments,
  addlikePostTraining,
...
const TrainerFeeData = ({ PostTrainingData }) => {
  ...
  const [selectedItems, setSelectedItems] = useState(
    Array(PostTrainingData?.length).fill(false)
  );
  ...
  const [showMoreArray, setShowMoreArray] = useState(
    new Array(PostTrainingData?.length).fill(false)
  );
  ...
  const [messageShowMoreBasedOnProfile, setMessageShowMoreBasedOnProfile] =
    useState([]);
  ...
  const downloadFileHandler = () => {
    ...
    link.href = fileLink;
    link.download = selectedPost?.tocFile?.tocFileName || "download"; // Set default filename if tocFileName is not available
    link.click();
  };
  // console.log('link',link)
  // console.log('post',PostTrainingData);
  ...
  return (
    <section>
      <PopUp trigger={PopUpButton} setTrigger={setPopUpButton}></PopUp>
      <TrainerApplyPopup
        trigger={applyPopUp}
        setTrigger={setApplyPopUp}
        selectedPost={selectedPost}
        trainderId={trainer?._id}
      ></TrainerApplyPopup>

      {/* <h3 style={{ color: '#888888', fontSize: '16px', marginTop: '10px' }}>Based on Your Profile</h3> */}

      <section
        className="feedcontentRight"
        ref={showmoreRef2}
            ...
            {PostTrainingData?.map((post, index) => (
              <div className="" key={index}>
                <div className="centered-section2">
                  ...
                  >
                    <div style={{ display: "flex" }}>
                      <div style={{ marginRight: "10px" }}>
                        ...
                        {
                          post?.postedByImg?<img className="w-[50px] h-[50px] rounded-full" src={post?.postedByImg} alt=""/>
                          :<div className="w-[50px] h-[50px] rounded-full justify-center items-center">{post?.postedByName[0]}</div>
                        }
                      </div>
                    ...
                    <div className="flex items-center">
                      <div
                        className="inst me-5"
                        onClick={() => handleIconClick(index, post)}
                      >
                        {selectedItems[index] ? (
                          <svg
                  ...
                  <p
                    className={
                      showMoreArray[index] ? "show-more2" : "show-less2"
                    }
                    ...
                    <div className="skilldata2">
                      ...
                      >
                        ...
                        <div className="skillfooter2">
                          <div
                            onClick={() => handleIconClick2(index, post?._id)}
                          >
                  ...
                  <button
                    onClick={() => handleShowMoreClick(index, post)}
                    style={{
                      background: "none",
                      border: "none",
                      color: "#2676C2",
                      ...
                      >
                        <div className="skillFooter">
                          ...
                          <p style={{ margin: "0px" }}>
                            ...
                            <span
                              style={{ color: "#2676C2", fontWeight: "400px" }}
                            >
                              - {post.modeOfTraining}
                            </span>{" "}
                          </p>
                            ...
                            <form onSubmit={handleAddComment} className="flex">
                              <div>
                                <input
                                  value={addNewComment}
                                  onChange={(e) => {
                                    setAddNewComment(e.target.value);
                                  }}
                                  type="text"
                                  style={{
